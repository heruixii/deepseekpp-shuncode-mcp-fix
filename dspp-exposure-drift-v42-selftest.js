...
// [1] policy
{
  ...
  ok('fixture cost is below the .43 trigger (64 KB)', total > 30000 && total < 64000, String(total));
  ...
  ok('trigger literal is 64000 (Fix 3.3.10.43)', polSrc.includes('triggerBudget=Math.max(64000,adaptiveBudget*2)'));
...
ok('manifest 1.14.0.53 / Fix 3.3.10.42', mf.version === '1.14.0.53' && mf.version_name === '1.14.0 ShunCode MCP Fix 3.3.10.48');

> **2026-09-18 更新：当前 .48 / 1.14.0.53。** 安装、完整验证及边界以 [Release .48](docs/RELEASE-Fix3.3.10.48.md) 为准；下文旧版本测试/状态作为历史保留。新专项50/50、独立验证12检查/74进程/64套件、部署后64/64；真实浏览器生成验收尚待升级后完成。

...
| 当前正式版 | **`1.14.0.50 / DeepSeek++ ShunCode MCP Fix 3.3.10.45`**（GitHub：main `6c1a471`，Release `v1.14.0-fix3.3.10.44` **Latest**，ZIP SHA `e300e535…90fe`；live 219 文件） |

...
(async()=>{
test('version',['1.14.0.33','1.14.0.34','1.14.0.35','1.14.0.36','1.14.0.37'].includes(manifest.version));
test('version name',['1.14.0 ShunCode MCP Fix 3.3.10.28','1.14.0 ShunCode MCP Fix 3.3.10.29','1.14.0 ShunCode MCP Fix 3.3.10.30','1.14.0 ShunCode MCP Fix 3.3.10.31','1.14.0 ShunCode MCP Fix 3.3.10.32'].includes(manifest.version_name));

...
(async()=>{
test('version',['1.14.0.32','1.14.0.33','1.14.0.34','1.14.0.35'].includes(manifest.version));
test('version name',['1.14.0 ShunCode MCP Fix 3.3.10.27','1.14.0 ShunCode MCP Fix 3.3.10.28','1.14.0 ShunCode MCP Fix 3.3.10.29','1.14.0 ShunCode MCP Fix 3.3.10.30'].includes(manifest.version_name));

...
ok(['1.14.0.1','1.14.0.2','1.14.0.3','1.14.0.4','1.14.0.5'].includes(manifest.version),'real MV3 version bumped');ok(['1.14.0 ShunCode MCP Fix 3.3.6','1.14.0 ShunCode MCP Fix 3.3.7','1.14.0 ShunCode MCP Fix 3.3.8','1.14.0 ShunCode MCP Fix 3.3.9','1.14.0 ShunCode MCP Fix 3.3.10'].includes(manifest.version_name),'version_name updated');

...
ok(['1.14.0.1','1.14.0.2'].includes(manifest.version),'real MV3 version bumped');ok(['1.14.0 ShunCode MCP Fix 3.3.6','1.14.0 ShunCode MCP Fix 3.3.7'].includes(manifest.version_name),'version_name updated');

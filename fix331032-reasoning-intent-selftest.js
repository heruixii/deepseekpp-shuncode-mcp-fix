...
console.log("\n[1] build integrity");
ok("manifest version is 1.14.0.37", manifest.version === "1.14.0.37", manifest.version);
ok("manifest version_name is Fix 3.3.10.32",
   manifest.version_name === "1.14.0 ShunCode MCP Fix 3.3.10.32", manifest.version_name);
